...
start_metals ()
{
  ...
  $PODMAN run \
    ...
    \
    --env MTLS_SSL_CERTIFICATE="${SERVER_PUBLIC_CERT}" \
    --env MTLS_SSL_CERTIFICATE_KEY="${SERVER_PRIVATE_KEY}" \
    --env MTLS_SSL_TRUSTED_CERTIFICATE="${TRUST_CHAIN}" \
    --env MTLS_SSL_CLIENT_CERTIFICATE="${TRUST_CHAIN}" \
    \
